...
- Avoid using ?? to get around type errors.
...
- Avoid obscure workarounds or creating extra artifacts (tmp folders, new tools
  ) without explaining and getting approval; consult docs before introducing new tools.
